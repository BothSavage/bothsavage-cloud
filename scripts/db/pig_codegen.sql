DROP DATABASE IF EXISTS `bothsavage_codegen`;

CREATE DATABASE  `bothsavage_codegen` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;
USE bothsavage_codegen;
