...
package com.cadillac.auth.config;

import com.cadillac.auth.support.CustomeOAuth2AccessTokenGenerator;
import com.cadillac.auth.support.core.CustomeOAuth2TokenCustomizer;
import com.cadillac.auth.support.core.FormIdentityLoginConfigurer;
import com.cadillac.auth.support.core.PigDaoAuthenticationProvider;
import com.cadillac.auth.support.handler.PigAuthenticationFailureEventHandler;
import com.cadillac.auth.support.handler.PigAuthenticationSuccessEventHandler;
import com.cadillac.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.cadillac.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationProvider;
import com.cadillac.auth.support.sms.OAuth2ResourceOwnerSmsAuthenticationConverter;
import com.cadillac.auth.support.sms.OAuth2ResourceOwnerSmsAuthenticationProvider;
